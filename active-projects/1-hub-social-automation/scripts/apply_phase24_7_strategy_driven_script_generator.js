...
const servicePath = "modules/intelligence/services/generate_scripts_from_briefs.js";
...
if (!serviceCode.includes("getActiveChannelIdentity")) {
...
console.log("✅ Phase 24.7 strategy-driven script generator patch applied");
