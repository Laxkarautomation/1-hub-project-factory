...
write("modules/image-factory/services/image_generation_strategy_resolver.js", `function cleanText(value = "") {
  return String(value || "")
    .toLowerCase()
    .replace(/[^\\w\\s\\u0900-\\u097F]/g, " ")
    .replace(/\\s+/g, " ")
...
write("modules/image-factory/run_image_strategy_resolver.js", `const fs = require("fs");
const path = require("path");
const {
  buildImageGenerationStrategyReport
