...
write(p("modules/admin-platform/services/autonomous_factory_readiness_service.js"), `const fs = require("fs");
const path = require("path");
...
write(p("modules/admin-platform/run_phase24_7_autonomous_factory_readiness_check.js"), `const readiness = require("./services/autonomous_factory_readiness_service");
